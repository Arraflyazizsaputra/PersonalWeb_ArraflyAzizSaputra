    ...
    <div class="flex max-w-7xl mx-auto mt-8 px-4">
        ...
        <main class="w-3/4 bg-white rounded shadow p-6 ml-6">
            <form action="proses_edit_artikel.php" method="post" class="space-y-6">
                ...
                <div>
                    <label for="nama_artikel" class="block text-sm font-medium textgray-700 mb-1">Judul Artikel</label>
                ...
                <div>
                    <label for="isi_artikel" class="block text-sm font-medium textgray-700 mb-1">Isi Artikel</label>
                    <textarea id="isi_artikel" name="isi_artikel" rows="5" required
                        class="w-full p-2 border rounded focus:outline-none focus:ring focus:border-blue-500"><?php echo htmlspecialchars($data['isi_artikel']);
                        ?></textarea>
                    <div>
                        <div class="flex justify-end space-x-4">
                            <button type="submit" class="bg-blue-700 text-white px-4 py-2 rounded hover:bg-blue-800 transition">Update</button>
                            <a href="data_artikel.php" class="bg-gray-300 text-gray-700 px-4 py-2 rounded hover:bggray-400 transition">Batal</a>
                        </div>
            </form>
        </main>
    </div>
